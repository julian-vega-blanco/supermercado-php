      ...
      <div class="menuTabla contenedor2">
        ...
        <table class="table table-custom ">
          ...
          <tr>
            ...
            <td>
            <a class="btn btn-warning" href="actualizarCampers.php?id=<?=$val['id']?>">Editar</a>
            </td>
          </tr>
            <?php } ?>
          </tbody>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarEstudiantes.php" method="post">
              <div class="mb-1 col-12">
                <label required for="nombres" class="form-label">nombres</label>
                <input 
                  type="text"
                  id="nombres"
                  name="nombres"
              ...
              <div class="mb-1 col-12">
                <label required for="decripcion" class="form-label">decripcion</label>
                <input 
                  type="text"
                  id="decripcion"
                  name="decripcion"
