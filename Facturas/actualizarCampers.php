...
$data -> setidfactura($_POST['idfactura']);
$data -> setidempleado($_POST['idempleado']);
$data -> setidcliente($_POST['idcliente']);
...
$idclientePath = "images/"; 
$idclientees = scandir($idclientePath);


$idclientees = array_filter($idclientees, function ($item) {
