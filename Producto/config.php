...
class Config extends conectar{
    ...
    public function insertData(){
        try {
            $stm =$this-> dbCnx -> prepare("INSERT INTO producto(nombres, decripcion, imagen) values(?,?,?)");
    ...
    public function obtainAll(){
        try {
            $stm =$this-> dbCnx -> prepare("SELECT * FROM producto");
            $stm -> execute();
            return $stm->fetchAll();
        } catch (Exception $e) {
            return $e->getMessage();
    ...
    public function delete(){
        try {
            $stm =$this-> dbCnx -> prepare("DELETE FROM producto WHERE id = ?");
            $stm->execute([$this->id]);
            return $stm-> fetchAll();
    ...
    public function selectOne(){
        try {
            $stm =$this-> dbCnx -> prepare("SELECT * FROM producto WHERE id = ?");
            $stm->execute([$this->id]);
            return $stm-> fetchAll();
        } catch (Exception $error) {
            return $error->getMessage();
    ...
    public function update(){
        try {
            $stm =$this-> dbCnx -> prepare("UPDATE producto SET nombres = ?, decripcion = ?, imagen = ? WHERE id = ?");
