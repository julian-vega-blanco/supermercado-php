...
class Config extends conectar{
    ...
    public function insertData(){
        try {
            $stm =$this-> dbCnx -> prepare("INSERT INTO proveerdor(nombres, decripcion, imagen) values(?,?,?)");
    ...
    public function obtainAll(){
        try {
            $stm =$this-> dbCnx -> prepare("SELECT * FROM proveerdor");
            $stm -> execute();
            return $stm->fetchAll();
        } catch (Exception $e) {
            return $e->getMessage();
    ...
    public function delete(){
        try {
            $stm =$this-> dbCnx -> prepare("DELETE FROM proveerdor WHERE id = ?");
            $stm->execute([$this->id]);
            return $stm-> fetchAll();
    ...
    public function selectOne(){
        try {
            $stm =$this-> dbCnx -> prepare("SELECT * FROM proveerdor WHERE id = ?");
            $stm->execute([$this->id]);
            return $stm-> fetchAll();
        } catch (Exception $error) {
            return $error->getMessage();
    ...
    public function update(){
        try {
            $stm =$this-> dbCnx -> prepare("UPDATE proveerdor SET nombres = ?, decripcion = ?, imagen = ? WHERE id = ?");
