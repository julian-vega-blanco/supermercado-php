...
$data -> setdireccionempleado($_POST['direccionempleado']);
...
<div class="a">
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              <div class="mb-1 col-12">
                <label required for="empleado" class="form-label">Nombre</label>
                <input 
                  type="text"
                  id="empleado"
                  name="empleado"
                  class="form-control"  
                 value="<?php echo $val['empleado'];?>"
                 required
                />
              </div>
              ...
              <div class="mb-1 col-12">
                ...
                <input 
                  ...
                  value="<?php echo $val['direccionempleado']; ?>"
                  required
                />
              </div>
