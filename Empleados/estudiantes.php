      ...
      <div class="menuTabla contenedor2">
        <table class="table table-custom ">
          ...
          <tr>
            ...
            <td><?php echo $val ['empleado']?></td>
            <td><?php echo $val ['celularempleado']?></td>
            <td><?php echo $val ['direccionempleado']?></td>
            ...
            <td><a class="btn btn-warning" href="actualizarCampers.php?id=<?=$val['id']?>">Detalle</a></td>
          </tr>
            <?php } ?>
          </tbody>
          ...
          <div class="modal-body" style="background-color: rgb(231, 253, 246);">
            <form class="col d-flex flex-wrap" action="registrarEstudiantes.php" method="post">
              <div class="mb-1 col-12">
                <label required for="empleado" class="form-label">Empleado</label>
                <input 
                  type="text"
                  id="empleado"
                  name="empleado"
              ...
              <div class="mb-1 col-12">
                <label required for="celularempleado" class="form-label">Celular del Empleado</label>
                <input 
                  type="number"
                  id="celularempleado"
              ...
              <div class="mb-1 col-12">
                <label required for="direccionempleado" class="form-label">Direccion del Empleado</label>
                <input 
                  type="text"
